...
<Cards>
  <Card title="Surfaces" href="/docs/guide/surfaces" description="The five entrypoint types and what each one is for." />
  <Card title="File Conventions" href="/docs/reference/file-conventions" description="Every special filename, as reference." />
</Cards>
