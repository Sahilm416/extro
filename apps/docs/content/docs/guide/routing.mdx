...
<Cards>
  <Card title="Linking and Navigating" href="/docs/guide/navigating" description="The Link component and the navigation hooks." />
  <Card title="File Conventions" href="/docs/reference/file-conventions" description="page.tsx, layout.tsx, error.tsx, and not-found.tsx as reference." />
</Cards>
