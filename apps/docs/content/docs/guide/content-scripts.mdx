...
<Cards>
  <Card title="Assets" href="/docs/guide/assets" description="web_accessible_resources, asset(), and public files." />
  <Card title="Dev Mode" href="/docs/guide/dev-mode" description="How content script changes propagate without reloads." />
</Cards>
